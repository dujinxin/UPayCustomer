//
//  UPayOrderRecordsController.swift
//  UPayCustomer
//
...
class UPayOrderRecordsController: UPayTableViewController {
    ...
    override func viewDidLoad() {
        ...
        let headViewHeight : CGFloat = 44
        let rect = CGRect(x: 0, y: 0, width: kScreenWidth, height: kScreenHeight - 140 - headViewHeight - kTabBarHeight)
    ...
    override func request(page: Int) {
        ...
        self.vm.orderList(searchTime: time, tradeType: 0, orderNum: "", orderStatus: self.orderStatus) { (_, msg, isSuc) in
...
extension UPayOrderRecordsController {
